...
print "<tr> <td width=90><b>IP Address</b></td>\n";
#print "<td><input name=serverip size=40 value=\"$wiseconf{'ServerIP'}\"> </td></tr>\n";
print "<td><input name=serverip size=40 value=\"".&agent_serverip()."\"> </td></tr>\n";
print "<tr> <td width=90><b>Device Name</b></td>\n";
#if($wiseconf{'DeviceName'}) {
if(&agent_devicename()) {
#print "<td><input name=devicename size=40 value=\"$wiseconf{'DeviceName'}\"> </td></tr>\n";
print "<td><input name=devicename size=40 value=\"".&agent_devicename()."\"> </td></tr>\n";

} else {
print "<td><input name=devicename size=40 value=\"".&get_system_hostname()."\"> </td></tr>\n";
}
print "<tr> <td width=90><b>Device ID</b></td>\n";
#print "<td><td name=deviceid size=40 value=\"$wiseconf{'DevID'}\"> </td></tr>\n";
print "<td><input name=deviceid size=40 value=\"".&agent_devid()."\" readonly> </td></tr>\n";
...
print "<tr> <td><table>\n";
print "<tr $tb> <td colspan=4><b>$text{'cloudserver'}</b></td> </tr>\n";
print "<tr> <td colspan=4 width=420>WISE Agent is not install.</td>\n";
print "</table></td></tr></table>\n";
print "</form>\n";
print &ui_hr();
}
